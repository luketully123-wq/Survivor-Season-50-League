...
index ce2543d31a9dc7057aab46f19bcb5a4fc9841279..4900272b653552d86b5582a486f7a044be4bed61 100644
--- a/src/App.tsx
+++ b/src/App.tsx
@@ -1,48 +1,51 @@
...
+  cast_member_id: string
 ...
 export default function App() {
   ...
   async function load() {
     ...
     setLoading(true)
     try {
@@ -87,77 +90,63 @@ export default function App() {
...
@@ -191,387 +180,377 @@ const playerNameById = new Map(data.players.map((p) => [p.id, p.name]))
   if (!data || !computed) {
     return (
       <div className="wrap">
         <div className="card">
